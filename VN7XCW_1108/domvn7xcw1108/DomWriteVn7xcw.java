...
public class DomWriteVN7XCW {
	...
	public static void main(String[] args) {
		...
		try {
			...
			File xmlFile = new File("VN7XCW_orarend.xml");
			...
			StreamResult result = new StreamResult(new File("VN7XCW_orarend.xml"));

			transformer.transform(src, result);

			System.out.println("Az VN7XCW_orarend1.xml fájl elkészült.");
